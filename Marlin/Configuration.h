...
#define HOMING_FEEDRATE {50*60, 50*60, 800, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,140}  // gt2 belts w/ 20t pulleys, JKM42 linear stepper motors and prusa multi-color 4 motor
